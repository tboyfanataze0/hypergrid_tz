...
- **Магазин** 
  ...
  - Покупка предметов за игровую валюту и донатную валюту
...
- **Баттл-пассы** (/battlepass)
  - Обычный - цепочка квестов с наградами (будет предоставлено дополнительно)
  - Премиум - цепочка квестов с улучшенными наградами (будет предоставлено дополнительно)
...
- **Аир-дропы**
  ...
  - 3 вида аирдропа ( обычный, эпический, и легендарный)
...
- **Титулы**
  ...
  - Возможность создать свой титул за плату на сайте ( без ограничений) 
...
2.Сделать менюшки под шоп и добавить вещи в шоп ( список скину позже)
